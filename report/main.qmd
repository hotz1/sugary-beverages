...
## Boxplots
Below is a boxplot of the proportion of total sales coming from zero-calorie drinks by day of the week
...
Below is the plot summarizing which observations have missing data and in which variables. A missing data table is also given, summarizing the number and percentage of missing observations for variables across sites. Site and variable combinations with no missing data points are ommited from the table
