...
A plot of the proportion of total sales coming from zero-calorie drinks over experiment day (@fig-1), shows the trends of sales across each site over day. There was some difference at the begining of the experiment, but over time the average proportion seemed relatively stable, which is not expected.
...
A missing data plot showed that orange juice, 100% juice and sports drinks had many missing observations. The plot also showed that some observations had no sale measurements. A missing data table also showed many missing juice or sport drink sales, additionally showing that some sites did not record some of these sales at all. 
