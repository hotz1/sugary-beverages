...
2.  Plots of the proportion of total sugary and zero-calorie sales coming from zero-calorie drinks over counts, such as Figure 1, can be used to observe and identify the patterns over time. These plots can also be stratified by other variables, such as intervention to identify differences between groups.
